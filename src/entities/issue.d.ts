...
export class IssueAttachment extends PersistentFile {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<IssueAttachment>;
}
...
export class Issue extends BaseEntity {
  ...
  readonly links: { [key: string]: YTSet<Issue>, added: YTSet<Issue>, removed: YTSet<Issue> };
   ...
   * @since 2024.3.43260
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<Issue>;
   ...
   * @since 2019.2.53994
   */
  addAttachment(content: InputStream | string, name: string, charset?: string, mimeType?: string): IssueAttachment;
   ...
   * @since 2019.2.53994
   */
  addAttachment(json: { content: InputStream | string; name: string; charset?: string; mimeType?: string }): IssueAttachment;
   ...
   * @returns The new work item
   */
  addWorkItem(json: { description: string; date: number; author: User; duration: number; type: WorkItemType }): IssueWorkItem;
   ...
   * @returns The attachment that is added to the issue
   */
  addAttachment(json: { content: string | InputStream; name: string; charset?: string; mimeType?: string }): IssueAttachment;
...
export class IssueComment extends BaseComment {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<IssueComment>;
