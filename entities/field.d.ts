...
export class ProjectCustomField extends BaseEntity {
   ...
   */
  oldValue(fieldName: string): string | number | boolean | BaseEntity | User | Date | null;
...
export class Fields {
   ...
   * @returns If the field is set to the expected value, returns true
   */
  static becomes(field: string | ProjectCustomField, expected: unknown): boolean;
   ...
   * @returns If the user can update the field, returns true
   */
  static canBeWrittenBy(field: string | ProjectCustomField, user: User): boolean;
...
export class EnumField extends Field {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<EnumField>;
}
...
export class OwnedField extends Field {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<OwnedField>;
}
...
export class State extends Field {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<State>;
}
...
export class ProjectVersion extends Field {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<ProjectVersion>;
}
...
export class Build extends Field {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<Build>;
}
...
export class SimpleProjectCustomField extends ProjectCustomField {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<SimpleProjectCustomField>;
}
...
export class TextProjectCustomField extends SimpleProjectCustomField {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<TextProjectCustomField>;
}
...
export class PeriodProjectCustomField extends SimpleProjectCustomField {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<PeriodProjectCustomField>;
}
...
export class GroupProjectCustomField extends ProjectCustomField {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<GroupProjectCustomField>;
...
export class BundleProjectCustomField extends ProjectCustomField {
   ...
   */
  static findByExtensionProperties(extensionPropertiesQuery: Record<string, unknown>): YTSet<BundleProjectCustomField>;
